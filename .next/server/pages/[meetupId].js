...
const MeetupDetail = props => {
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])("section", {
    ...
    children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])("img", {
      className: MeetupDetail_module_default.a.img,
      src: props.img,
      alt: props.title
...
const getStaticPaths = async () => {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://El-Bebo:Bebon32@cluster0.xzgdy.mongodb.net/myFirstDatabase?retryWrites=true&w=majority");
  const db = client.db();
...
/* harmony default export */ var _meetupId_ = __webpack_exports__["default"] = (MeetupId);
